...
3. We will be using [`conda`](https://docs.conda.io/projects/conda/en/stable/) package manager to create a virtual environment `chatbot` using `c` and then `conda activate chatbot` to activate the environment.
